...
import { assertEquals, assertThrowsAsync, assertThrows } from 'https://deno.land/std@0.102.0/testing/asserts.ts';
...
Deno.test('readValidObjJsonFileWithRelativePath', async function (): Promise<void> {
